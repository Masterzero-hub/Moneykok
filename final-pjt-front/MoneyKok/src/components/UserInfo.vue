  ...
  <div class="container mt-5">
    <form>
      ...
      <div class="mb-3">
        ...
        <br>
        <button type="button" class="btn-small-common btn-mint" style="width: 100%;" @click="goPasswordChange">비밀번호 수정하기</button>
      </div>
      ...
      <!-- 제출 버튼 -->
      <div class="btn-group">
        <button type="submit" class="btn-small-common btn-mint" @click.prevent="handleUpdate">수정하기</button>
        <button type="submit" class="btn-small-common btn-dark" @click.prevent="handleSignOut">회원탈퇴</button>
      </div>
    </form>
  </div>
</template>
...
const handleUpdate = () => {
  ...
  if (
    ...
    const payload = {
      ...
      formattedPhone: store.formattedPhone, // `store.` 추가
